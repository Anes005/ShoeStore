...
function CartProduct(product) {
    ...
    const [handleChange, setHandleChange]= React.useState(1);
    return (
        <div className="flex w-full">
            ...
            <div className="flex flex-col md:flex-row w-1/3 justify-center gap-2">
                <div>
                    <button className="bg-slate-900 text-white text-lg font-bold px-4 py-2 rounded-md mx-2 hover:bg-slate-100 hover:text-slate-900 transition-colors duration-200 ease-in" onClick={() => setHandleChange(product, -1)}>-</button>
                </div>
                <div>
